pub fn side_bar() -> Html {
    ...
    <div>
      ...
      <p class="text-gray-800 dark:text-gray-200">{"Can be enabled from your system"}</p>
      <p class="text-gray-800 dark:text-gray-200">{"(e.g., From Control Center on the Mac)"}</p>
